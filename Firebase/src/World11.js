...
class World11 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapCSV('jungle1', "../assets/TileMaps/jungle1.csv");
    ...
    create() {
        ...
        map = this.make.tilemap({key: "jungle1", tileWidth: 64, tileHeight: 64});
        ...
        // Create Player
        player = this.physics.add.sprite(192, 1664, "Monkey");
